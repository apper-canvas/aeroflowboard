  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 p-6 space-y-6">
        ...
        {tasks.length === 0 && !searchTerm && Object.keys(filters).length === 0 ? (
          <Empty
            title="No tasks yet"
            description="Start organizing your work by creating your first task. You can drag and drop tasks between columns to track progress."
